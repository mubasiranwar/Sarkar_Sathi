...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-navy-50 to-white">
      {/* Hero Section */}
      <section className="bg-linear-to-br from-navy-900 via-navy-800 to-navy-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">{t('about.title', language)}</h1>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-navy-100">
            <h2 className="text-3xl font-bold text-navy-900 mb-6 text-center">{t('about.mission', language)}</h2>
            <p className="text-lg text-navy-700 leading-relaxed mb-4">
              {t('about.mission1', language)}
            </p>
            <p className="text-lg text-navy-700 leading-relaxed">
              {t('about.mission2', language)}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-navy-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-navy-900 mb-12 text-center">{t('about.team', language)}</h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            {/* Umair Nazeer */}
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-navy-100 hover:shadow-xl transition-shadow">
              <div className="text-center mb-6">
                <div className="w-24 h-24 bg-linear-to-br from-navy-600 to-navy-800 rounded-full mx-auto mb-4 flex items-center justify-center">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <Cpu className="w-5 h-5 text-navy-600 mt-0.5 shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Code className="w-5 h-5 text-navy-600 mt-0.5 shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Eye className="w-5 h-5 text-navy-600 mt-0.5 shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Award className="w-5 h-5 text-navy-600 mt-0.5 shrink-0" />
                  <div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-navy-100 hover:shadow-xl transition-shadow">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <Rocket className="w-5 h-5 text-navy-600 mt-0.5 shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Network className="w-5 h-5 text-navy-600 mt-0.5 shrink-0" />
                  <div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-navy-100">
            <h2 className="text-3xl font-bold text-navy-900 mb-6 text-center">{t('about.technology', language)}</h2>
            <div className="text-center">
              <div className="inline-flex items-center gap-3 bg-linear-to-r from-navy-100 to-navy-50 px-6 py-4 rounded-xl mb-6">
              ...
              <p className="text-navy-700 leading-relaxed">
                {t('about.aiDescription', language)}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-navy-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">{t('about.ready', language)}</h2>
          <p className="text-navy-200 mb-8">
            {t('about.askAny', language)}
          </p>
          <a
            href="/#/assistant"
